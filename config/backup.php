...
return [
    ...
    'backup' => [
        ...
        'destination' => [
             ...
             */
            'disks' => [
                env('BACKUP_FILESYSTEM_DISK', 'backup'),
            ],
        ],
    ...
    'monitor_backups' => [
        [
            'name' => env('BACKUP_NAME', env('APP_NAME', 'laravel-backup')),
            'disks' => [env('BACKUP_FILESYSTEM_DISK', 'backup')],
            'health_checks' => [
    ...
    'cleanup' => [
        ...
        'default_strategy' => [
             ...
             */
            'keep_all_backups_for_days' => env('BACKUP_KEEP_ALL_BACKUPS_FOR_DAYS', 7),
             ...
             */
            'keep_weekly_backups_for_weeks' => env('BACKUP_KEEP_WEEKLY_BACKUPS_FOR_WEEKS', 0),

            /*
             * After the "keep_weekly_backups_for_weeks" period is over, the most recent backup
             * of that month will be kept. Older backups within the same month will be removed.
             */
            'keep_monthly_backups_for_months' => env('BACKUP_KEEP_MONTHLY_BACKUPS_FOR_MONTHS', 0),
